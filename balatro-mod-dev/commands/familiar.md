...
Also check `references/lua-gotchas.md` in the plugin for general pitfalls relevant to this mod's patterns (FFI cdata if it touches numbers, local scoping if large single files, etc.).
