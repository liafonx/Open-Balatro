...
<example>
Context: Main agent needs lovely patch syntax
user: 'Find lovely patch examples for card evaluation'
assistant: 'I will invoke the lovely-patch-researcher agent to find relevant patch patterns.'
<commentary>Triggers when Lovely patch research is needed.</commentary>
</example>"
model: sonnet
color: yellow
